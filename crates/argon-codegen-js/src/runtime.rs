//! JS-specific runtime code for the Argon standard library.
//!
//! This module contains the JavaScript runtime IIFE, primitive type mappings,
//! and TypeScript definition generation. These are target-specific and belong
//! in the JS codegen crate rather than the language-level stdlib.
...
pub(crate) fn get_runtime() -> &'static str {
    r#"
(function(global) {
    'use strict';
